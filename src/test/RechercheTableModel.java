...
public class RechercheTableModel extends AbstractTableModel {
    ...
    public RechercheTableModel(String login, String nom, String prenom,String email,String nationnalite,Date dateInscription,Date dateNaissance, Boolean sexe, String[] type) { //remplissage de la liste des stocks
