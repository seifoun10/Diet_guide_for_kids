...
public class NewClass extends javax.swing.JFrame {
    ...
    RecherchePanel panel = new RecherchePanel();
    Boolean sexe=null;
    ...
    private void loginTFActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
    }                                       

    private void loginTFKeyTyped(java.awt.event.KeyEvent evt) {                                 
        // TODO add your handling code here:
    }                                

    private void loginTFKeyPressed(java.awt.event.KeyEvent evt) {                                   
        // TODO add your handling code here: 
        
    }                                  

    private void loginTFKeyReleased(java.awt.event.KeyEvent evt) {                                    
        // TODO add your handling code here:
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                   

    private void nomTFKeyReleased(java.awt.event.KeyEvent evt) {                                  
        // TODO add your handling code here:
         rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                 

    private void prenomTFKeyReleased(java.awt.event.KeyEvent evt) {                                     
        // TODO add your handling code here:
         rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                    
    ...
    private void nationnaliteTFKeyReleased(java.awt.event.KeyEvent evt) {                                           
        // TODO add your handling code here:
       rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                          

    private void dateInscriptionDPPropertyChange(java.beans.PropertyChangeEvent evt) {                                                 
        // TODO add your handling code here:
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                                

    private void dateNaissanceDPPropertyChange(java.beans.PropertyChangeEvent evt) {                                               
        // TODO add your handling code here:
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                              

    private void femmeRBActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        sexe= new Boolean(false);
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                       

    private void hommeRBActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        sexe= new Boolean(true);
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                       

    private void tousRBActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        sexe= null;
        rechercheT.setModel(new MyTableModel(loginTF.getText(), nomTF.getText(),prenomTF.getText(),emailTF.getText(),nationnaliteTF.getText(),dateInscriptionDP.getDate(),dateNaissanceDP.getDate(),sexe,type.split(" ")));
    }                                      

    private void adminCBActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
    ...
    private void forumCBActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
    ...
    private void parentCBActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    ...
    private void pediatreCBActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void dateNaissanceDPActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }
    ...
    private javax.swing.JPanel jPanel1 = new GradientPanel();
