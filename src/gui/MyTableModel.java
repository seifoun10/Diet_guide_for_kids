...
public class MyTableModel extends AbstractTableModel {
    ...
    String []header = {"Login","Nom","Prenom","Email","Date d'inscription","Date de naissance","Sexe","Nationalité"};
    
    public MyTableModel(String login, String nom, String prenom,String email,String nationnalite,Date dateInscription,Date dateNaissance, Boolean sexe) { //remplissage de la liste des stocks
        ...
        listUser=new UserDao().getUserList(login,nom,prenom,email,nationnalite,dateInscriptionSQL,dateNaissanceSQL,sexe);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) { 
        switch (columnIndex) {// parcour par colonne
            ...
            case 4://colonne adresse depot
                return listUser.get(rowIndex).getDateInscription();
            case 5://colonne adresse depot
                return listUser.get(rowIndex).getDateNaissance();
