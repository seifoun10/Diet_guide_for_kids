...
private FacebookClient facebookClient;
 Date d;
     ...
     */
     public String nom1,prenom1,login1,pass1,confpass1,mail1,date1,nbenf1,nationalite;
     Boolean sexe;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // nationalite=natio.getSelectedItem().toString();
        ...
        parent2.setDateNaissance((java.sql.Date) dateVi);
    ...
    private void faceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_faceActionPerformed
        ...
        facebookClient = new DefaultFacebookClient("CAAU4Cy66fHIBAE9OSrw1SUVNfV6XR6cacdKbxEkh9tQf02ZBgWomK6tcVmb9lhkl4BVzZClsZCuHOjnVj3miT9kdiZAE465S2fnZAxOrZB2xKikAx1pHnm6GDOqC7ZCZAqH7JliRD63GZAhIWyWeFuYZBEu6QZCXUuUvMm7WZC6oLssX54GChmcDKvxe");
   ...
   // out.println("Sexe: " + user.getGender());
    out.println("Nom: " + user.getLastName());
    out.println("Prenom: " + user.getFirstName());
    
    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yy");

      try {
        d = sdf.parse(user.getBirthday());
